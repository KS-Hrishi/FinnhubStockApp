...
namespace FinnhubStockApp.Controllers
{
    ...
    public class TradeController : Controller
    {
        ...
        public async Task<IActionResult> OrdersPDF()
        {
            ...
            orders.AddRange((IEnumerable<IOrderResponse>)await _stocksService.GetBuyOrders());
            orders.AddRange((IEnumerable<IOrderResponse>)await _stocksService.GetSellOrders());
